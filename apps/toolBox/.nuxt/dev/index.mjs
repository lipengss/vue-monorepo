...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://E:/web/web-project/apps/toolBox/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/web/web-project/apps/toolBox/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/web/web-project/apps/toolBox/node_modules/devalue/index.js';
import destr from 'file://E:/web/web-project/apps/toolBox/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://E:/web/web-project/apps/toolBox/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://E:/web/web-project/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://E:/web/web-project/apps/toolBox/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://E:/web/web-project/apps/toolBox/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/web/web-project/apps/toolBox/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/web/web-project/apps/toolBox/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/web/web-project/apps/toolBox/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://E:/web/web-project/apps/toolBox/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/web/web-project/apps/toolBox/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/web/web-project/apps/toolBox/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://E:/web/web-project/apps/toolBox/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/web/web-project/apps/toolBox/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/web/web-project/apps/toolBox/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/web/web-project/apps/toolBox/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://E:/web/web-project/apps/toolBox/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://E:/web/web-project/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/web/web-project/apps/toolBox/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/web/web-project/apps/toolBox/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/web/web-project/apps/toolBox/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\web\\web-project\\apps\\toolBox","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\web\\web-project\\apps\\toolBox\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\web\\web-project\\apps\\toolBox\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\web\\web-project\\apps\\toolBox\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\web\\web-project\\apps\\toolBox\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _n3aZSfVwE7 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/web/web-project/apps/toolBox";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _KYRZ2trZmx = (nitroApp) => {
...
const _lazy_b55sdK = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_b55sdK, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_b55sdK, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"viewport":"width=device-width, initial-scale=1"};
...
const getClientManifest = () => import('file://E:/web/web-project/apps/toolBox/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/web/web-project/apps/toolBox/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
